...
export const Timeline = ({
  ...
  return (
    (<div
      className="w-full font-sans md:px-10 mt-32  h-[80rem] bg-black  bg-dot-white/[0.2]  relative "
      ref={containerRef}>
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <h3
                className="hidden md:block text-xl md:pl-20 md:text-3xl font-bold text-[#817cb4] dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>
